            ...
            <div className='bg-[#DEB887] w-4/5 h-5/6 rounded-3xl'>
                <div className='bg-white w-11/12 mx-auto h-1/4 flex items-center mt-12 rounded-xl shadow-card'>
                    ...
                    <div  className='flex flex-col gap-10 h-full justify-center  mr-20 text-white w-4/12 '>
                        <button className='bg-primary  ml-auto py-2 px-8 rounded-3xl text-xl font-bold shadow-butao'>15 Min...</button>
                        <button className='bg-primary  ml-auto py-2 px-5  rounded-3xl text-xl font-bold shadow-butao'>R$20,00</button>
                    </div>
                ...
                <div className='bg-white w-11/12 mx-auto h-1/4 flex items-center mt-10 rounded-xl shadow-card'>
                    ...
                    <div  className='flex flex-col gap-10 h-full justify-center  mr-20 text-white w-4/12 '>
                        <button className='bg-primary  ml-auto py-2 px-8 rounded-3xl text-xl font-bold shadow-butao'>4 Horas</button>
                        <button className='bg-primary  ml-auto py-2 px-5  rounded-3xl text-xl font-bold shadow-butao'>R$380,00</button>
                    </div>
                ...
                <div className='bg-white w-11/12 mx-auto h-1/4 flex items-center mt-10 rounded-xl shadow-card'>
                    ...
                    <div  className='flex flex-col gap-10 h-full justify-center  mr-20 text-white w-4/12 '>
                        <button className='bg-primary  ml-auto py-2 px-8 rounded-3xl text-xl font-bold shadow-butao'>2 Horas</button>
                        <button className='bg-primary  ml-auto py-2 px-5  rounded-3xl text-xl font-bold shadow-butao'>R$120,00</button>
                    </div>
